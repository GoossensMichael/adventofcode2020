...
public class MainDay17Part2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int x = 0; x < inputLines.size(); x++) {
            ...
            for (int y = 0; y < inputLine.length; y++) {
                cubes.put(coordsToString(x, y, 0, 0), new Cube(inputLine[y] == '#'));
            }
        }
    ...
    public static int[][] applyCycle(final Map<String, Cube> cubes, final int[][] dimensions) {
        ...
        for (int w = dimensions[3][0] - 1; w <= dimensions[3][1] + 1; w++) {
                    ...
                    for (int y = dimensions[1][0] - 1; y <= dimensions[1][1] + 1; y++) {
                        ...
                        if (cube == null) {
                            ...
                            if (desiredState) {
                                ...
                                dimensionExpansion[3][0] = Math.min(dimensionExpansion[3][0], w);
                                dimensionExpansion[3][1] = Math.max(dimensionExpansion[3][1], w);
                            }
                        }
    ...
    private static String coordsToString(final int x, final int y, final int z, final int w) {
